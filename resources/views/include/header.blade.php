                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @if (Session::has('client'))
                        <li class="nav-item"><a href="{{ URL::to('/client-logout') }}"
                                class="nav-link"><span class="fa 	fa-user"></span>Deconnexion</a></li>
                    @else
                        <li class="nav-item"><a href="{{ URL::to('/client-login') }}"
                                class="nav-link"><span class="fa fa-user"></span>Connexion</a></li>

                    @endif
                    <li class="nav-item"><a href="{{ URL::to('/apropos') }}" class="nav-link">A
                            propos</a>
                    </li>
                    <li class="nav-item"><a href="{{ URL::to('/contactez-nous') }}"
                            class="nav-link">Contactez-nous</a></li>
                </ul>
            </div>
        </div>
    </nav>
